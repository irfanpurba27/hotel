...
<center>
  ...
  <thead>
    <tr class="bg-primary" style="color:white">
      ...
      <th scope="col">Keterangan Fasilitas</th>
  ...
  @foreach($fhotel as $key=>$fhotel)
        <tr>
            ...
            <td>
            <a href="{{ route('fhotel.edit', $fhotel) }}" class="btn btn-primary  btn-sm" style="float:left;color: white"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
