...
Route::middleware('role:admin')->get('kamar', [App\Http\Controllers\KamarController::class, 'index'])->name('kamar.index');
Route::middleware('role:admin')->post('/kamar/create', [App\Http\Controllers\KamarController::class, 'store'])->name('kamar.create');
Route::middleware('role:admin')->get('/kamar/{kamar}/edit', [App\Http\Controllers\KamarController::class, 'edit'])->name('kamar.edit');
Route::middleware('role:admin')->patch('/kamar/{kamar}/edit', [App\Http\Controllers\KamarController::class, 'update'])->name('kamar.update');
Route::middleware('role:admin')->delete('/kamar/{kamar}/delete', [App\Http\Controllers\KamarController::class, 'destroy'])->name('kamar.destroy');
...
Route::middleware('role:admin')->get('room', [App\Http\Controllers\RoomController::class, 'index'])->name('room.index');
Route::middleware('role:admin')->get('/room/{room}/edit', [App\Http\Controllers\RoomController::class, 'edit'])->name('room.edit');
Route::middleware('role:admin')->patch('/room/{room}/edit', [App\Http\Controllers\RoomController::class, 'update'])->name('room.update');
...
Route::middleware('role:resepsionis')->delete('resepsionis/{reservasi}/batal', [App\Http\Controllers\ReservasiController::class, 'destroyy'])->name('resepsionis.destroyy');
