...
class FkamarController extends Controller
{
    ...
    {   
        ...
        ->join('rooms', 'rooms.tipe', '=', 'fkamars.tipe')
        ->get();
    ...
    public function store(Request $request){
        ...
        return redirect('/fasilitas-kamar')->withToastSuccess('Fasilitas Berhasil di Tambahkan');
    ...
    {   
        ...
        return redirect('/fasilitas-kamar')->withToastSuccess('Data Berhasil diperbarui');
    }

    public function destroy(Fkamar $fkamar){
        $fkamar->delete();
        return redirect('/fasilitas-kamar')->withToastSuccess('Hapus Data Berhasil');
    }
