...
class ReservasiController extends Controller
{
    ...
    public function index()
    {
        ...
        ->join('rooms', 'rooms.tipe', '=', 'reservasis.tipe')
        ->get();
    ...
    {   
        ...
        //  dd($tipe);
        return view('tamu.cetaksatu', ['reservasis' => $reservasi],['tipe'=>$tipe]);
    }
    ...
    public function store(Request $request)
    {
        ...
        $kat = Room::find($request->tipe);
        $jml = $kat->jumlah - $total;
    ...
    {   
       $cekin= reservasi::find($id);
        $kat = room::where('id', $cekin->tipe)->value('jumlah');
        $jml = $kat + $cekin->total;               
         $updt = room::where('id', $cekin->tipe)->update(['jumlah' =>  $jml]);   
        $cekin->delete();
