...
class FhotelController extends Controller
{
    ...
    public function store(Request $request){
        ...
        $upload->save();
        return redirect('/fasilitas-hotel')->withToastSuccess('Fasilitas Berhasil ditambahkan');
    ...
    {   
        ...
        return redirect('/fasilitas-hotel')->withToastSuccess('Fasilitas berhasil diperbarui');
    }
    ...
    public function destroy($id){
        ...
        return redirect('/fasilitas-hotel')->withToastSuccess('hapus data berhasil');
    }
